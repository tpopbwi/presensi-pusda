...
async function loadData() { 
    ...
    try { 
        ...
        showToastOnce('load_fail', "Koneksi Gagal", "Tidak dapat terhubung ke server dan tidak ada data tersimpan.", "error");
    } finally { 
        const o = document.getElementById('initialLoadingOverlay'); 
        if (o) { o.style.opacity = '0'; o.style.pointerEvents = 'none'; setTimeout(() => o.style.display = 'none', 400); } 
    } 
...
// ============================================================
// SET STATUS PRESENSI (Dengan validasi status khusus)
// ============================================================
function setS(el, st) {
